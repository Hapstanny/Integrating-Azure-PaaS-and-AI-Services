...
public class DatabaseService : IDatabaseService
{
    ...
    /// <summary>
    /// Get bookings for a single hotel that are after a specified date.
    /// </summary>
    [KernelFunction]
    [Description("Get bookings for a single hotel that are after a specified date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate( [Description("The ID of the hotel")] int hotelId, [Description("Booking date of the hotel")] DateTime dt)
    {
 ...
 [KernelFunction]
 [Description("Get bookings that have more than one hotel room associated with them.")]
